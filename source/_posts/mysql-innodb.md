...
### 缓冲池(Buffer Pool)
缓冲池的设计目的是为了协调CPU速度与磁盘速度的鸿沟。 [时延参考数据](https://gist.github.com/jboner/2841832) :
```text
...
1. [数据库事务原子性、一致性是怎样实现的？](https://www.zhihu.com/question/30272728)
1. 《Mysql技术内幕 InnoDB存储引擎》
1. [InnoDB关键特性之double write](https://www.cnblogs.com/geaozhang/p/7241744.html)
1. [InnoDB 重要特性 Double Write 实现原理](https://juejin.cn/post/6890830002162499598)
1. [mysql 为何需要Double Write？有redo log还不够吗？](https://blog.csdn.net/synchronizing/article/details/109025093)
1. [MySQL：数据库宕机以后恢复的过程？如何保证事务的ACID特性？](https://www.zhihu.com/question/59729819/answer/284180647)
1. [On learning InnoDB: A journey to the core](https://blog.jcole.us/innodb/)
1. [innodb_support_xa的作用](http://blog.itpub.net/15498/viewspace-2153760/)
1. https://www.cnblogs.com/AlmostWasteTime/p/10330151.html
1. https://dev.mysql.com/doc/refman/8.0/en/innodb-locking.html
1. [Innodb行锁源码学习(一)](https://www.cnblogs.com/cchust/p/4255499.html)
1. [MySQL Innodb行锁剖析](https://zhuanlan.zhihu.com/p/139489272)
1. [MySQL 加锁处理分析](https://github.com/hedengcheng/tech/blob/master/database/MySQL/MySQL%20%E5%8A%A0%E9%94%81%E5%A4%84%E7%90%86%E5%88%86%E6%9E%90.pdf)
